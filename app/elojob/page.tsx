                            ...
                            {(onClose) => (
                                <>
                                        ...
                                        <ul>
                                            ...
                                            <li className='flex-wrap'>
                                                <lucide.Dot /> {valueTextSize.length > 0 ? (
                                                    <p className='text-default-'> Mensagem: <span className='text-default-500 text-small'> ({valueTextSize})</span> </p>
                                    ...
                                    <ModalFooter className='flex justify-between items-center'>
                                        ...
                                        <Button isDisabled={!agreedTerms} className='text-de' color="success" variant="shadow" onPress={onClose}>
